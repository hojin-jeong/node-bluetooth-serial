...
* Pork node-bluetooth-serial-port (https://github.com/eelcocramer/node-bluetooth-serial-port) Project
* Refactoring lib Codes (apply class, promise)
* BT Buffer Size Increasement (1024 -> 4096)
